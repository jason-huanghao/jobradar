...
遇到 bug、有功能建议，或者想分享你用 JobRadar 拿到 offer 的喜讯？

欢迎关注微信公众号，直接留言反馈，或订阅后续更新：

<div align="center">
<img src="https://raw.githubusercontent.com/jason-huanghao/PicGoBed/master/imgs/202603101718363.png" width="200" alt="微信公众号" />
<br/><em>扫码关注 · 留言反馈</em>
</div>

也欢迎通过 [GitHub Issue](https://github.com/jason-huanghao/jobradar/issues) 或 [Discussion](https://github.com/jason-huanghao/jobradar/discussions) 参与讨论。

---

## ☕ 支持项目

JobRadar 完全免费开源。如果它帮你节省了时间，或者顺利拿到了面试，不妨请作者喝杯咖啡——用来抵消服务器费用、测试 API 的花销，以及无数个改 bug 的深夜。

<div align="center">
<img src="https://raw.githubusercontent.com/jason-huanghao/PicGoBed/master/imgs/202603101748931.png" width="360" alt="微信支付 & 支付宝" />
<br/><em>微信支付 &nbsp;·&nbsp; 支付宝</em>
</div>

当然，给项目点个 ⭐ Star、或者把它分享给正在求职的朋友，同样是莫大的支持。🌟
